"use strict";
import { calculatePopulation, civData, curCiv, gameLog, isValid, ui, updateWonder, wonderCount, wonderResources } from "../index.js";
...
function speedWonder() {
    if (civData.coins.owned < 10000) { return; }
    civData.coins.owned -= 10000;
...
export {
    tallyWonderCount, getWonderBonus, startWonder, renameWonder, wonderSelect, getWonderCostMultiplier, speedWonder, haveDeity, doLabourers, getWonderLowItem,
getWonderProduction, isWonderLimited, getLabourerMods};
